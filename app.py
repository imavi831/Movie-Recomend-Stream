...
if st.button('Recommend'):
    ...
    with col1:
        ...
        st.markdown(
            f'''
                <a target="_blank" href="https://www.2embed.to/embed/tmdb/movie?id={movie.iloc[movie_lst[0][0]].movie_id}">
                    <button>
                        Go to Movie
                    </button>
                </a>
    ...
    with col2:
        ...
        st.markdown(
            f'''
                <a target="_blank" href="https://www.2embed.to/embed/tmdb/movie?id={movie.iloc[movie_lst[1][0]].movie_id}">
                    <button>
                        Go to Movie
                    </button>
                </a>
    ...
    with col3:
        ...
        st.markdown(
            f'''
                <a target="_blank" href="https://www.2embed.to/embed/tmdb/movie?id={movie.iloc[movie_lst[2][0]].movie_id}">
                    <button>
                        Go to Movie
                    </button>
                </a>
    ...
    with col4:
        ...
        st.markdown(
            f'''
                <a target="_blank" href="https://www.2embed.to/embed/tmdb/movie?id={movie.iloc[movie_lst[3][0]].movie_id}">
                    <button>
                        Go to Movie
                    </button>
                </a>
    ...
    with col5:
        ...
        st.markdown(
            f'''
                <a target="_blank" href="https://www.2embed.to/embed/tmdb/movie?id={movie.iloc[movie_lst[4][0]].movie_id}">
                    <button>
                        Go to Movie
                    </button>
                </a>
